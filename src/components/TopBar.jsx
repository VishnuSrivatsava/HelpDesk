...
const NavButton = ({ title, customFunc, icon, color, dotColor }) => (
    <Tippy content={title} position="BottomCenter">
      <button
        ...
        onClick={() => customFunc()}
        style={{ color }}
        className="relative text-xl rounded-full p-3 hover:bg-black"
      >
        <span
...
const TopBar = () => {
    ...
    return (      
            <div className="flex justify-between p-1 relative bg-gradient-to-r from-white-400
            ...
            <div className="flex px-5 items-center">
                ...
                <BiSearch  className="h-7 w-7 text-black"/>
                <input type="text" placeholder="Search for tickets ..."
                className=" bg-transparent border-0 text-black placeholder-black
            ...
            <div className="flex space-x-6">
                ...
                <div className="flex items-center text-black">
                    <h3 className="font-bold mr-3">ABC</h3>
                    <img
