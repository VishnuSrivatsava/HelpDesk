...
const AddTicket = () => {
    ...
    return (
        <div className="overflow-y-auto p-10 flex flex-col mx-auto h-screen max-w-full border-x-4 bg-gradient-to-r from-purple-100
        to-blue-200">
            ...
            <div className='container h-5/6 mx-auto mt-5 px-20 grid grid-cols-1 border-t-4 border-indigo-200 '>
                ...
                <div className="flex items-center">
                    ...
                    <h4 className="flex flex-1 text-4xl font-bold text-gray-600">Create Ticket</h4>
                        ...
                        <div className=' text-2xl font-serif' >
                            <form>
                                ...
                                <label className='block mb-2 text-2xl font-medium text-gray-900 dark:text-gray-400'>
                                    ...
                                    <option className='text-2xl' value="c">C</option>
                                    <option className='text-2xl' value="d">D</option>
                                    </select>

                                    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                    <br /><br />
                                    <br /><br />
                                    <button className="bg-blue-500 hover:bg-blue-700 text-white font py-2 px-4 rounded-full">
                                        Submit
                                    </button>
                                    </div>
                                </label>
