...
const Board = () => {
  ...
  const { ready, setReady, boardData, setBoardData, showForm, setShowForm,
    selectedBoard, setSelectedBoard } = useStateContext();
  ...
  const onTextAreaKeyPress = (e) => {
      ...
      return (
          /* Flex Container  */
              ...
              <div className="overflow-y-auto p-10 flex flex-col h-screen">
                  {/* Board header */}
                  <div className="flex flex-initial justify-between">
                      <div className="flex items-center">
                          <h4 className="text-4xl font-bold text-black-600">Tickets</h4>
                          <ChevronDownIcon
                        ...
                        absolute inset-x-0 top-0"
...

                                                          {
                                                              showForm && selectedBoard === bIndex ? (
                                                                  <div className="p-3">
                                                                      <textarea className="border-gray-300 rounded focus:ring-green-400 w-full"
